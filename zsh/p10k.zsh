# Generated by Powerlevel10k configuration wizard on 2020-09-27 at 23:51 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    #dotfiles                # dotfiles dirty status
  ...
  ####################################[ dotfiles: dirty status of dotfiles ]####################################
  function prompt_dotfiles() {
    local dirty_state=$(git -C $DOTFILES status --porcelain)
    [ -z "$dirty_state" ] && return
    p10k segment -f 208 -t 'dotfiles are 💩'
  }

  ####################################[ pipenv: pipenv virtual environment ]####################################
  function prompt_pipenv() {
    [ -z "$PIPENV_NAME" ] && return
    p10k segment -f 37 -t "in 🐍 $PIPENV_NAME"
  }
